...
LDLIBSOPTIONS=-lthrift -lthriftnb -levent -lpthread -lmemcached -lleveldb
...
${OBJECTDIR}/LevelDB.o: LevelDB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LevelDB.o LevelDB.cpp
...
${OBJECTDIR}/ProfileService.o: ProfileService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProfileService.o ProfileService.cpp

${OBJECTDIR}/ProfileServiceConstants.o: ProfileServiceConstants.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProfileServiceConstants.o ProfileServiceConstants.cpp
...
${OBJECTDIR}/ProfileServiceTypes.o: ProfileServiceTypes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProfileServiceTypes.o ProfileServiceTypes.cpp
