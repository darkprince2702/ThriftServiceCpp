...
${OBJECTDIR}/profileservice_constants.o: profileservice_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/profileservice_constants.o profileservice_constants.cpp

${OBJECTDIR}/profileservice_types.o: profileservice_types.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/profileservice_types.o profileservice_types.cpp
